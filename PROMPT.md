...
> **Jak použít:** Zkopíruj celý tento text jako systémový prompt (system prompt) nebo instrukce do jakéhokoliv LLM — ChatGPT, Gemini, Claude, Copilot, Mistral, atd. Pak pošli text k humanizaci.
